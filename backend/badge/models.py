...
class PlayerBadge(models.Model):
    ...
    id          = models.AutoField(primary_key=True)
    user        = models.ForeignKey(User, models.CASCADE, verbose_name='所有者', related_name='badges')
    type        = models.ForeignKey(BadgeType, models.CASCADE, verbose_name='勋章类型', related_name='+')
    acquired_at = models.DateTimeField('日期', auto_now_add=True)
